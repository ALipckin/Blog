...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">{{$date->translatedFormat('F')}} {{$date->day}}, {{$date->year}} • {{$date->format('H:i')}} • Featured • {{$post->comments->count()}} Комментария</p>
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <section class="comment-section">
                        ...
                        @auth()
                    <section class="comment-section">
                        <h2 class="section-title mb-5 aos-init" data-aos="fade-up">Отправить комментарии</h2>
